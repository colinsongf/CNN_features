...
def initial_network_custom(proto_path, model_path, mean_path):
    ...
    net = caffe.Classifier(proto_path,
                           model_path,
                           mean = np.load('/data/sichen/caffe_svcl/caffe/python/caffe/imagenet/places_mean.npy').mean(1).mean(1),
                           channel_swap=(2,1,0),
                           raw_scale=255,
                           image_dims=(256,256))
    return net
...
def main():
    ...
    print np.load('/data/sichen/caffe_svcl/caffe/python/caffe/imagenet/places_mean.npy').mean(1).mean(1)
