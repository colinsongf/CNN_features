...
import numpy as np
import sys
caffe_root = '/data/sichen/caffe_svcl/caffe_lsun/'
...
def initial_network_vgg16():
    net = caffe.Net(caffe_root+'models/vgg16/VGG_ILSVRC_16_layers_conv.prototxt',
                           caffe_root+'models/vgg16/vgg_16_conv_model.caffemodel')
...
def main():
    ...
    elif options.mode == 'VggNet16':
        net = initial_network_vgg16()
    else :
